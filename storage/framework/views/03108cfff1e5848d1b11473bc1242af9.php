    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="ms-3">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-login me-2">
                        Login
                    </a>
        ...
        <div class="container-lg">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary-grad">
...
<?php /**PATH C:\Users\PC_07\aplikasi_bk\resources\views/landing.blade.php ENDPATH**/ ?>