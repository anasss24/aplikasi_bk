                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #0099C9;"><?php echo e($totalSiswa ?? 0); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #0077B6;"><?php echo e(count($jadwalHariIni ?? [])); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #0099C9;"><?php echo e($totalRiwayat ?? 0); ?></h3>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(0, 153, 201, 0.1); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #0077B6;"><?php echo e($materiDiupload ?? 0); ?></h3>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(0, 119, 182, 0.1); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('jadwal.index')); ?>" class="btn btn-sm btn-outline-primary">Lihat Semua</a>
                </div>
                        ...
                        <div class="border-bottom px-4 py-3 d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <?php if($jadwal->status): ?>
                                    <span class="badge bg-success mt-2"><?php echo e($jadwal->status); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('riwayat.index')); ?>" class="btn btn-sm btn-outline-primary">Lihat Semua</a>
                </div>
                <div class="card-body p-0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\aplikasi_bk\resources\views/dashboard/guru_bk.blade.php ENDPATH**/ ?>