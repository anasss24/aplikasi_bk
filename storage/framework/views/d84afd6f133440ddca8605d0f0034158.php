            ...
            <div class="welcome-hero">
                <div class="hero-content">
                    <div class="logo-wrapper">
                        <img src="<?php echo e(asset('images/logo-sekolah.jpg')); ?>" alt="Logo SMK Antartika 1">
                    </div>
            ...
            <div class="welcome-auth">
                <div class="auth-content">
                    ...
                    <div class="auth-buttons">
                        <a href="<?php echo e(route('login')); ?>" class="auth-btn auth-btn-primary">
                            <i class="fas fa-arrow-right"></i> Masuk ke Platform
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="auth-btn auth-btn-secondary">
...
<?php /**PATH C:\aplikasi_bk\resources\views/welcome.blade.php ENDPATH**/ ?>