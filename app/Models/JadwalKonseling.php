...
class JadwalKonseling extends Model
{
    ...
    protected $fillable = [
      'jadwal_id','siswa_id','guru_id','jadwal_datetime','status','catatan_admin','approved_by','lokasi','metode'
    ];
    ...
    public function approvedBy(){ return $this->belongsTo(User::class, 'approved_by', 'user_id'); }
