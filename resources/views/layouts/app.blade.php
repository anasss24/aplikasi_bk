...
<head>
    ...
    <title>@yield('title', 'Aplikasi BK')</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('home') }}" class="@if(request()->routeIs('home', 'dashboard')) active @endif">
            ...
            @auth
                @if((Auth::user()->role ?? null) === 'siswa')
                    ...
                    <li>
                        <a href="{{ route('jadwal.index') }}" class="@if(request()->routeIs('jadwal.*')) active @endif">
                            <i class="fas fa-calendar-alt"></i>
                            <span>Jadwal Konseling</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('riwayat.index') }}" class="@if(request()->routeIs('riwayat.*')) active @endif">
                            <i class="fas fa-history"></i>
                            <span>Riwayat Konseling</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('assessment.index') }}" class="@if(request()->routeIs('assessment.*')) active @endif">
                    ...
                    <li>
                        <a href="{{ route('materi.index') }}" class="@if(request()->routeIs('materi.*')) active @endif">
                            <i class="fas fa-book"></i>
                            <span>Materi BK</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('kuisioner.index') }}" class="@if(request()->routeIs('kuisioner.*')) active @endif">
                ...
                @elseif((Auth::user()->role ?? null) === 'guru_bk')
                    ...
                    <li>
                        <a href="{{ route('siswa.index') }}" class="@if(request()->routeIs('siswa.*')) active @endif">
                ...
                @elseif((Auth::user()->role ?? null) === 'admin')
                    ...
                    <li>
                        <a href="{{ route('admin.kelas.index') }}" class="@if(request()->routeIs('admin.kelas.*')) active @endif">
                            <i class="fas fa-school"></i>
                            <span>Data Kelas</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.jurusan.index') }}" class="@if(request()->routeIs('admin.jurusan.*')) active @endif">
                            <i class="fas fa-sitemap"></i>
                            <span>Data Jurusan</span>
                        </a>
                    </li>
                    <li>
                        <a href="/admin/siswa" class="@if(request()->routeIs('admin.siswa.*')) active @endif">
                            <i class="fas fa-users"></i>
                            <span>Data Siswa</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.profile') }}" class="@if(request()->routeIs('admin.profile')) active @endif">
                            <i class="fas fa-cog"></i>
                            <span>Pengaturan</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('log.index') }}" class="@if(request()->routeIs('log.*')) active @endif">
                    ...
                    <a href="#" class="user-menu text-decoration-none text-dark" data-bs-toggle="dropdown">
                        ...
                        <div class="user-info">
                            @auth
                                ...
                                <p class="role">{{ ucfirst(str_replace('_', ' ', Auth::user()->role ?? 'user')) }}</p>
                            @endauth
                        </div>
                    </a>
