...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h2 fw-bold text-dark mb-0">Tambah Siswa</h1>
                    ...
                    <form method="POST" action="/admin/siswa">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nis" class="form-control @error('nis') is-invalid @enderror" value="{{ old('nis') }}" pattern="[0-9]{1,10}" inputmode="numeric" maxlength="10">
                                @error('nis')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nisn" class="form-control @error('nisn') is-invalid @enderror" value="{{ old('nisn') }}" required pattern="[0-9]{1,10}" inputmode="numeric" maxlength="10">
                                @error('nisn')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="kelas_id" class="form-select @error('kelas_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($kelas as $k)
                                        <option value="{{ $k->kelas_id }}" @if(old('kelas_id') == $k->kelas_id) selected @endif>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="no_telepon" class="form-control" value="{{ old('no_telepon') }}" inputmode="numeric" pattern="[0-9]+" maxlength="12" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>
