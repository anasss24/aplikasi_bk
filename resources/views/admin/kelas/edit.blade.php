    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/admin/kelas/{{ $kelas->kelas_id }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_kelas') is-invalid @enderror" 
                                   id="kode_kelas" name="kode_kelas" value="{{ old('kode_kelas', $kelas->kode_kelas) }}" required>
                            @error('kode_kelas')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tingkat') is-invalid @enderror" 
                                ...
                                <option value="10" {{ old('tingkat', $kelas->tingkat) == 10 ? 'selected' : '' }}>X (Kelas 1)</option>
                                <option value="11" {{ old('tingkat', $kelas->tingkat) == 11 ? 'selected' : '' }}>XI (Kelas 2)</option>
                                <option value="12" {{ old('tingkat', $kelas->tingkat) == 12 ? 'selected' : '' }}>XII (Kelas 3)</option>
                            </select>
                            @error('tingkat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
